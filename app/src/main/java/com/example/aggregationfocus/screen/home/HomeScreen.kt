...
import com.example.aggregationfocus.MainMongoData
import com.example.aggregationfocus.fetchDataFromMongoDB
import com.example.aggregationfocus.getMongoClient
    ...
    Column(
        ...
        Column {
            ...
            TextField(
                ...
                placeholder = { Text(text = "My Age") }
            )

//            MainMongoData(collection, 20)
            MainMongoData()
...
@Composable
fun PersonView(id: String, name: String, age: String, timestamp: RealmInstant) {
